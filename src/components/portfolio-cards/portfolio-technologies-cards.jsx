...
export default function PortfolioTechnologiesCards() {
  return (
    <div className="portfolio-cards">
      <div className="row-animated-cards">
        <div
          className="animated-card animated-card-fifth fifth-project-card"
          id="mobile-app"
        >
        ...
        <div className="animated-card animated-card-sixth sixth-project-card">
          <div className="card-images">
            <div className="portfolio-logo-image">
      ...
      <div className="row-animated-cards">
        <div
          className="animated-card animated-card-third"
        ...
        <div className="animated-card animated-card-fourth">
          <div className="card-images">
            <div className="portfolio-logo-image">
